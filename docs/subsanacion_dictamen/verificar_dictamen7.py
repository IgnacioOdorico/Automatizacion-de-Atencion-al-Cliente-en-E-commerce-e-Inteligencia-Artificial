...
# 17/09 (dictamen del 15/09, grupo B): cada revisión lleva etiqueta nueva; la vigente es -r6 (auditoría de cuarta instancia, 18/09).
check('C5  la etiqueta de la versión citada es la nueva', TODO.count('entrega-2026-09-r6') == 2
