...
const DEFINITIONS: readonly Definition[] = [
  {
    ...
    flow: 'Pedidos',
    measures: 'Desde que el pedido entra al sistema hasta que termina de procesarse.',
    from: 'received_at',
    to: 'processed_at',
  },
  {
  ...
  },
  {
    ...
    flow: 'Asistente',
    measures: 'Desde que llega el mensaje del cliente hasta que el asistente le responde.',
    from: 'received_at',
    to: 'responded_at',
  },
];
